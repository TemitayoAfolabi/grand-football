  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-body-sm text-text-secondary">
        Predict Premier League scores each gameweek. Points are awarded based on how close your
        prediction is to the actual result.
      </p>
            ...
            <tbody className="divide-y divide-border">
              ...
              <tr>
                <td className="py-3 pr-4">
                  ...
                  <div className="text-body-sm text-text-secondary">None of the above</div>
                </td>
                <td className="py-3 text-right">
      ...
      <Card>
        ...
        <p className="mb-3 text-body-sm text-text-secondary">
          One fixture per gameweek is designated the <strong>Star Game</strong>. Exact score
          predictions earn double points!
        </p>
        <div className="overflow-x-auto">
          <table className="w-full text-body-sm">
            <thead>
      ...
      <Card>
        ...
        <div className="space-y-3 text-sm text-text-secondary">
          <p>
            <strong>Correct Team Goals</strong> is a consolation point. You earn 1 point when:
          </p>
          <ul className="ml-4 list-disc space-y-1">
            <li>You predicted the wrong outcome (e.g., home win but it was an away win)</li>
            <li>
              But you correctly predicted the number of goals scored by <em>at least one</em> of the
              two teams
            </li>
          </ul>
          <div className="rounded-input bg-bg-secondary p-3">
            ...
            <p>
              You predicted <strong>2–1</strong> (home win), actual result was <strong>2–3</strong>{' '}
              (away win). The home team scored 2 in both your prediction and reality, so you get{' '}
      ...
      <Card>
        ...
        <div className="space-y-2 text-sm text-text-secondary">
          <p>
            Submit predictions <strong>on time</strong> (before each fixture&apos;s kickoff) for
            every fixture in a calendar month to earn a{' '}
            <Badge variant="star">+{SCORING.MONTHLY_BONUS} pts</Badge> bonus at month end.
          </p>
          <p>
            Submitting late (after kickoff) for even one fixture, or missing a fixture entirely,
            disqualifies you from the bonus that month. The bonus tracker on your dashboard shows
            how many of your predictions were submitted on time.
          </p>
        </div>
      </Card>
      ...
      <Card>
        ...
        <div className="space-y-2 text-sm text-text-secondary">
          ...
          <ol className="ml-4 list-decimal space-y-1">
            <li>
              <strong>Most exact scores</strong> — the player with more exact score predictions
              ranks higher.
            </li>
            <li>
              <strong>Most correct outcomes</strong> — if still tied, the player with more correct
              outcome predictions ranks higher.
            </li>
            <li>
              <strong>Fewest zero-point predictions</strong> — if still tied, the player with fewer
              wrong predictions ranks higher.
            </li>
          </ol>
        </div>
      </Card>
